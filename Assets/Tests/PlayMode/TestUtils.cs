...
namespace Solcery.Tests.PlayMode
{
    public static class TestUtils
    {
        ...
        public static void RegistrationOrdinaryBricks(IServiceBricks serviceBricks)
        {
            ...
            serviceBricks.RegistrationBrickType(BrickTypes.Value, BrickValueTypes.CardId, BrickValueCardId.Create);
            serviceBricks.RegistrationBrickType(BrickTypes.Value, BrickValueTypes.CardTypeId, BrickValueCardTypeId.Create);
            ...
            serviceBricks.RegistrationBrickType(BrickTypes.Action, BrickActionTypes.Iterator, BrickActionIterator.Create);
