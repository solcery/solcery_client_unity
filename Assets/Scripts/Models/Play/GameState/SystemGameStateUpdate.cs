...
using Solcery.Models.Play.GameState.StaticAttributes.Highlighted;
using Solcery.Models.Play.GameState.StaticAttributes.Interactable;
using Solcery.Models.Play.GameState.StaticAttributes.Place;
