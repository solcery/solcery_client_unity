...
{
    internal class CurrentContextObjectAttrs : IContextObjectAttrs
    {
        private readonly EcsWorld _world;

        public static IContextObjectAttrs Create(EcsWorld world)
        {
            return new CurrentContextObjectAttrs(world);
        }

        private CurrentContextObjectAttrs(EcsWorld world)
        {
            _world = world;
        }
